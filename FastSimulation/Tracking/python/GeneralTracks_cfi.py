...
else: # it differs from the above just in the name of the producer, all the rest is equal; is there a smarter way in our framework? I tried with cloning, but the old generalTracks still messed with the EDAlias
